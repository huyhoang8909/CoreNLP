...
//             sentence.get(i).set(CoreAnnotations.PartOfSpeechAnnotation.class, "A");
             ...
             sentence.get(i).set(CoreAnnotations.PartOfSpeechAnnotation.class, "V");
//        } else if(currentValue.equalsIgnoreCase("granite") || currentValue.equalsIgnoreCase("nilông") || currentValue.equalsIgnoreCase("boy") || currentValue.equalsIgnoreCase("you") || currentValue.equalsIgnoreCase("cactông") || currentValue.equalsIgnoreCase("radio") || currentValue.equalsIgnoreCase("rocket") || currentValue.equalsIgnoreCase("Para_Games") || currentValue.equalsIgnoreCase("copywriter") || currentValue.equalsIgnoreCase("creative_director") || currentValue.equalsIgnoreCase("slogan") || currentValue.equalsIgnoreCase("VietnamWorks.com") || currentValue.equalsIgnoreCase("Internet") || currentValue.equalsIgnoreCase("marketing") || currentValue.equalsIgnoreCase("Microsoft") || currentValue.equalsIgnoreCase("Cargill") || currentValue.equalsIgnoreCase("tivi") || currentValue.equalsIgnoreCase("sales") || currentValue.equalsIgnoreCase("OK") || currentValue.equalsIgnoreCase("New_World") || currentValue.equalsIgnoreCase("êkip") || currentValue.equalsIgnoreCase("vali") || currentValue.equalsIgnoreCase("bêtông") || currentValue.equalsIgnoreCase("bar") || currentValue.equalsIgnoreCase("tour") || currentValue.equalsIgnoreCase("Arona") || currentValue.equalsIgnoreCase("pôngtông") || currentValue.equalsIgnoreCase("bazan") || currentValue.equalsIgnoreCase("hănggô") || currentValue.equalsIgnoreCase("kaki") || currentValue.equalsIgnoreCase("Omo") || currentValue.equalsIgnoreCase("Tide") || currentValue.equalsIgnoreCase("cassette") || currentValue.equalsIgnoreCase("virus") || currentValue.equalsIgnoreCase("gas") || currentValue.equalsIgnoreCase("resort") || currentValue.equalsIgnoreCase("ăcqui") || currentValue.equalsIgnoreCase("karaoke") || currentValue.equalsIgnoreCase("bida") || currentValue.equalsIgnoreCase("boxing") || currentValue.equalsIgnoreCase("taekwondo") || currentValue.equalsIgnoreCase("judo") || currentValue.equalsIgnoreCase("karate") || currentValue.equalsIgnoreCase("Stadium") || currentValue.equalsIgnoreCase("taxi") || currentValue.equalsIgnoreCase("heroin") || currentValue.equalsIgnoreCase("hormon") || currentValue.equalsIgnoreCase("Beautiful_boxer") || currentValue.equalsIgnoreCase("diesel") || currentValue.equalsIgnoreCase("cờlê") || currentValue.equalsIgnoreCase("Oxy_shop") || currentValue.equalsIgnoreCase("salon") || currentValue.equalsIgnoreCase("oxy") || currentValue.equalsIgnoreCase("heroin") || currentValue.equalsIgnoreCase("pensées") || currentValue.equalsIgnoreCase("côppha") || currentValue.equalsIgnoreCase("container") || currentValue.equalsIgnoreCase("bù_loong") || currentValue.equalsIgnoreCase("ron") || currentValue.equalsIgnoreCase("mỏ_lết") || currentValue.equalsIgnoreCase("bù_loong") || currentValue.equalsIgnoreCase("tuktuk") || currentValue.equalsIgnoreCase("Vientiane") || currentValue.equalsIgnoreCase("fax") || currentValue.equalsIgnoreCase("Mobile") || currentValue.equalsIgnoreCase("Down") || currentValue.equalsIgnoreCase("email") || currentValue.equalsIgnoreCase("Lepers") || currentValue.equalsIgnoreCase("becgiê") || currentValue.equalsIgnoreCase("logic") || currentValue.equalsIgnoreCase("box") || currentValue.equalsIgnoreCase("vip") || currentValue.equalsIgnoreCase("mirco") || currentValue.equalsIgnoreCase("logo") )  {
//          sentence.get(i).set(CoreAnnotations.PartOfSpeechAnnotation.class, "Nb");
        }else {
          sentence.get(i).set(CoreAnnotations.PartOfSpeechAnnotation.class, currentTag);
        }
      }
