 ...
 */
public class CustomPOSTaggerAnnotator implements Annotator  {

  /** A logger for this class */
  private static Redwood.RedwoodChannels log = Redwood.channels(CustomPOSTaggerAnnotator.class);
   ...
   */
  public CustomPOSTaggerAnnotator() {
    this(false);
  }

  public CustomPOSTaggerAnnotator(boolean verbose) {
    this(System.getProperty("pos.model", MaxentTagger.DEFAULT_JAR_PATH), verbose);
  }

  public CustomPOSTaggerAnnotator(String posLoc, boolean verbose) {
   ...
   */
  public CustomPOSTaggerAnnotator(String posLoc, boolean verbose, int maxSentenceLength, int numThreads) {
    this(loadModel(posLoc, verbose), maxSentenceLength, numThreads);
  }

  public CustomPOSTaggerAnnotator(MaxentTagger model) {
    this(model, Integer.MAX_VALUE, 1);
  }

  public CustomPOSTaggerAnnotator(MaxentTagger model, int maxSentenceLength, int numThreads) {
    this.pos = model;
  ...
  public CustomPOSTaggerAnnotator(String annotatorName, Properties props) {
